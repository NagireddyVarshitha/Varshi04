...
def home_page():
    ...
    <img src='{get_image_base64("home_image.jpg")}'style=width:70%;height:200px;border-radius:10px;'>
    </div>
    """)
...
def benefits_page():
    ...
    put_html(f"""
    <div style = 'text-align:left;'>
    <img src='{get_image_base64("benefits_image.jpg")}'style=width:70%;height:200px;border-radius:10px;'>
    </div>
    """)
...
def precautions_page():
    ...
    put_html(f"""
    <div style = 'text-align:left;'>
    <img src='{get_image_base64("precaution_image.jpg")}'style=width:70%;height:200px;border-radius:10px;'>
    </div>
    """)
...
def symptoms_page():
    ...
    put_html(f"""
    <div style = 'text-align:left;'>
    <img src='{get_image_base64("symptoms_image.jpg")}'style=width:70%;height:200px;border-radius:10px;'>
    </div>
    """)
